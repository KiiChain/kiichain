...
- Ensure fee abstraction UpdateFeeTokens resets token prices to zero so BeginBlocker adopts the current TWAP immediately rather than being clamped from a stale governance-submitted price
