...
printf "12345678\n" | $seidbin tx dex register-contract $marsaddr $marsid false true 100000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
printf "12345678\n" | $seidbin tx dex register-contract $saturnaddr $saturnid false true 100000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
printf "12345678\n" | $seidbin tx dex register-contract $venusaddr $venusid false true 100000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
printf "12345678\n" | $seidbin tx dex register-contract $marsaddr2 $marsid false true 1000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
printf "12345678\n" | $seidbin tx dex register-contract $saturnaddr2 $saturnid false true 100000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
printf "12345678\n" | $seidbin tx dex register-contract $venusaddr2 $venusid false true 100000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
printf "12345678\n" | $seidbin tx dex register-contract $marsaddr3 $marsid false true 100000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
printf "12345678\n" | $seidbin tx dex register-contract $saturnaddr3 $saturnid false true 100000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
printf "12345678\n" | $seidbin tx dex register-contract $venusaddr3 $venusid false true 100000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
printf "12345678\n" | $seidbin tx dex register-contract $marsaddr4 $marsid false true 100000000000 -y --from=$keyname --chain-id=$chainid --fees=10000000ukii --gas=500000 --broadcast-mode=block
