...
// blockedAddrs is the 22 Aug 2026 incident deny list (hex + bech32).
// Normalized to lowercase at init.
var blockedAddrs = map[string]struct{}{}

// AddrPairs is the incident deny list as [hex, bech32] pairs.
var AddrPairs = [][2]string{
