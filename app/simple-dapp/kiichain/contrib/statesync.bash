...
mv genesis.cosmoshub-4.json ~/.kiichain/config/genesis.json
...
export KIICHAIND_STATESYNC_ENABLE=true
export KIICHAIND_P2P_MAX_NUM_OUTBOUND_PEERS=200
export KIICHAIND_STATESYNC_RPC_SERVERS="https://cosmos-rpc.polkachu.com:443,https://rpc-cosmoshub-ia.cosmosia.notional.ventures:443"
export KIICHAIND_STATESYNC_TRUST_HEIGHT=$BLOCK_HEIGHT
export KIICHAIND_STATESYNC_TRUST_HASH=$TRUST_HASH

# Fetch and set list of seeds from chain registry.
KIICHAIND_P2P_SEEDS=$(curl -s https://raw.githubusercontent.com/cosmos/chain-registry/master/cosmoshub/chain.json | jq -r '[foreach .peers.seeds[] as $item (""; "\($item.id)@\($item.address)")] | join(",")')
