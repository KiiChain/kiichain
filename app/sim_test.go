...
import (
	...
	"github.com/kiichain/kiichain/v6/ante"
	kiichain "github.com/kiichain/kiichain/v6/app"
	"github.com/kiichain/kiichain/v6/app/sim"
)

// AppChainID hardcoded chainID for simulation
const AppChainID = "kiichain-app"
...
func TestAppStateDeterminism(t *testing.T) {
	...
	for i := 0; i < numSeeds; i++ {
		...
		for j := 0; j < numTimesToRunPerSeed; j++ {
			...
			db := dbm.NewMemDB()
			dir, err := os.MkdirTemp("", "kiichain-simulation")
			...
			// NOTE: setting to zero to avoid failing the simulation
			// kiichain ante allows only certain proposals to be expedited - the simulation doesn't know about this
