...
import (
	...
	"github.com/kiichain/kiichain3/aclmapping/evm"
...
func (suite *KeeperTestSuite) PrepareTest() {
	...
	kiiAddr, associatedAcc := testkeeper.MockAddressPair()
	suite.App.EvmKeeper.SetAddressMapping(suite.Ctx, kiiAddr, associatedAcc)
