...
func verifyBlockResult(t *testing.T, resObj map[string]interface{}) {
	...
	require.Equal(t, "0x1dcc4de8dec75d7aab85b567b6ccd41ad312451b948a7413f0a142fd40d49347", resObj["sha3Uncles"])
	require.Equal(t, "0x273", resObj["size"])
	...
	require.Equal(t, "0xc1f0d26c419dea496540ab96a3331a9a79f084d7bc9662178dcd7c0bc407dc33", tx["hash"])
	...
	require.Equal(t, "0x538", tx["chainId"])
	require.Equal(t, "0x1", tx["v"])
	require.Equal(t, "0xf4379f3d6bb36f273deb0acff3dad7554e9694c6d735895801e6fb0d463e413d", tx["r"])
	require.Equal(t, "0x4b70793f51c10baca4bd6a8ee727664df08953aeed728a71d917fbdc5240270", tx["s"])
