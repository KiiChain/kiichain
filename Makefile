...
start-localnet-ci: build
	...
	./build/kiichaind genesis add-genesis-account val 10000000000000000000000000000000000000stake --home ~/.kiichaind-liveness --keyring-backend test
	./build/kiichaind genesis gentx val 1000000000000000000000stake --home ~/.kiichaind-liveness --chain-id localchain_1010-1 --keyring-backend test
