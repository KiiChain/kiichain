...
MONIKER="kii-rpc-node"
kiichaind init --chain-id kii "$MONIKER"

# Copy configs
cp integration_test/docker/rpcnode/config/app.toml ~/.kiichain3/config/app.toml
cp integration_test/docker/rpcnode/config/config.toml ~/.kiichain3/config/config.toml
