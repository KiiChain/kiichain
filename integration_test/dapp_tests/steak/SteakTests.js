...
describe("Steak", async function () {
  ...
  describe("Bonding and unbonding", async function () {
    ...
    it("Unassociated account should be able to bond", async function () {
      const unassociatedAccount = await setupAccount("unassociated", false, '2000000', 'ukii', owner.address);
      ...
      const newUnassociatedAccount = await setupAccount("unassociated", false, '2000000', 'ukii', owner.address);
