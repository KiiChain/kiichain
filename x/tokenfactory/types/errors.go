...
var (
	...
	ErrParsingKiiTokenFactoryQuery    = sdkerrors.Register(ModuleName, 15, "Error parsing KiiTokenFactoryQuery")
	...
	ErrUnknownKiiTokenFactoryQuery    = sdkerrors.Register(ModuleName, 23, "Error unknown kii token factory query")
