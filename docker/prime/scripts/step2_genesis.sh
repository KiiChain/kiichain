...
override_genesis '.consensus_params["evidence"]["max_age_num_blocks"]="200000"'
...
override_genesis '.app_state["staking"]["params"]["max_voting_power_ratio"]="0.25"'
...
then
  ...
  for account in $accounts; do
    ...
    printf "12345678\n" | kiichaind keys add "$name" >> build/generated/mnemonic.txt 2>&1
