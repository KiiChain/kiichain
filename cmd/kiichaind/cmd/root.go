...
func genesisCommand(txConfig client.TxConfig, basicManager module.BasicManager, cmds ...*cobra.Command) *cobra.Command {
	cmd := genutilcli.Commands(txConfig, basicManager, kiichain.DefaultNodeHome)
...
func (a appCreator) newApp(
	...
	if evmChainIdFlag != evmserverconfig.DefaultEVMChainID {
		logger.Warn(fmt.Sprintf("WARNING: The --%s flag is deprecated. The evm chain ID is being overridden to %d. Remove it from the start command and from '.kiichaind/config/app.toml' to remove the warning.",
